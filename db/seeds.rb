...
Product.delete_all
# Product.create!(title: 'Ahvileivapuu',
#   description:
...
#   prod_type: 'Books')
# . . .
Product.create!(title: 'Web Application Testing Book',
  description:
    %{Short introduction to testing Web Applications.},
  image_url: 'book1.jpg',
  price: 29.99,
  prod_type: 'Books')
Product.create!(title: 'Sunglasses 2AR',
  description:
    %{Stylish wooden sunglasses.},
  image_url: 'sun2.jpg',
  price: 26.00,
  prod_type: 'Sunglasses')
Product.create!(title: 'B45593 Sunglasses',
  description:
  ...
  price: 26.00,
  prod_type: 'Sunglasses')
Product.create!(title: 'Sunglasses B45593',
  description:
    %{Tempus iaculis urna id volutpat lacus laoreet. Sodales ut eu sem integer.},
  image_url: 'sun8.jpg',
  price: 26.00,
